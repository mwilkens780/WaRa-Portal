@extends('layouts.app')
@section('title', 'Teamarzt')
@section('page-title', 'Teamarzt – Untersuchungen')
...
<div class="mt-2 space-y-4">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
            ...
            <div>
                <h2 class="text-base font-semibold text-gray-800">Kandidaten – Sportmedizinische Untersuchung</h2>
                <p class="text-xs text-gray-400 mt-0.5">Schwimmer, die der Erfassung sportmedizinischer Daten zugestimmt haben</p>
            </div>
        </div>
        ...
        <div class="divide-y divide-gray-50">
            ...
            <a href="{{ route('teamdoctor.show', $candidate) }}"
               class="flex items-center justify-between px-6 py-3.5 hover:bg-gray-50 transition-colors">
                ...
                <div class="flex items-center gap-3">
                    <span class="text-xs text-gray-400">
                        {{ $candidate->healthDocuments()->where('category', 'sports_medicine')->count() }} Dokument(e)
                    </span>
