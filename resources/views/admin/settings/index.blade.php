...
<div class="max-w-2xl mt-2 space-y-6">
    ...
    {{-- Weitere Stammdaten, die keinen eigenen Menuepunkt brauchen --}}
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
            ...
            <h2 class="text-base font-semibold text-gray-800">Stammdaten</h2>
        </div>
        ...
        <a href="{{ route('admin.wa-scoring.index') }}"
           class="flex items-center gap-4 px-6 py-4 hover:bg-gray-50 transition-colors">
            ...
            <div class="flex-1 min-w-0">
                <p class="text-sm font-medium text-gray-800">WA Punktetabellen</p>
                <p class="text-xs text-gray-500 mt-0.5">
                    Basiszeiten für die Punkteberechnung nach World Aquatics, je Jahr und Bahnlänge
                </p>
            </div>
